          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            ...
            <div className="flex flex-col" style={{ gap: "18px" }}>
              <div className="flex items-center gap-3">
                ...
                >
                  16+ Projects Delivered Across All Platforms
                </span>
              </div>
              <div className="flex items-center gap-3">
                <Bell
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  Growth: 14+ years of continuous organic expansion
                </span>
              </div>
            </div>
            ...
            <p
              style={{
                ...
                fontSize: "13px",
                lineHeight: "1.7",
                color: isLightCard ? "rgba(10,10,10,0.6)" : "rgba(252,248,241,0.55)",
                marginTop: "24px",
                maxWidth: "420px",
              }}
            >
        ...
        <div className="flex items-center gap-3 mb-5">
          {socialLinks.map(({ label, svg }) => (
            <a
              ...
              href="#"
              aria-label={label}
              className={`flex items-center justify-center transition-colors duration-200 ${isLightCard
