...
const slides: SlideData[] = [
  {
    ...
    title: "EVERY DOOR OPENS TO SOMETHING LASTING",
    description:
      "Some things are measured in square feet. Others, in the lifetimes they hold.",
    pillTagline: "Searching for land or commercial space?",
  ...
  },
  {
    ...
    title: "PRECISION IS A PROMISE, NOT A PROCESS",
    description:
      "High-grade residential and commercial structures, delivered with structural integrity, sustainable engineering, and on-time execution.",
  ...
  },
  {
    ...
    title: "THE SPIRIT OF EVERY GATHERING",
    description:
      "The best moments are rarely planned around the main course — they\'re poured, shared, and remembered.",
